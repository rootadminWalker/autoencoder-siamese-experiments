...
encoder = load_model('outputs/mnist_autoencoder_outputs/latent_dim_16/encoder.h5')
decoder = load_model('outputs/mnist_autoencoder_outputs/latent_dim_16/decoder.h5')
